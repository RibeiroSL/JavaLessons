...
public class TelaValores extends javax.swing.JFrame {
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        /*
        lblDiv.setText(Float.toString(Float.parseFloat(txtNum.getText()) / Float.parseFloat(txtDen.getText())));
        lblRes.setText(Integer.toString(Integer.parseInt(txtNum.getText()) % Integer.parseInt(txtDen.getText()))); 
        */
        double num = Math.sqrt(Double.parseDouble(txtNum.getText()));
        lblRes.setText(Double.toString(num));
